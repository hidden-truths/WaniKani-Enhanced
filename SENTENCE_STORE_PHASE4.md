...
[SENTENCE_STORE_NLP.md](SENTENCE_STORE_NLP.md); the shipped Phase 1/2 plans + the original
vision were consolidated into [ROADMAP.html](ROADMAP.html) (store: completed).
If you are picking this work up cold, read the brief first, then this.
