...
| **JLPT** | **Exam mission control**: a countdown to your test date (default: N3, December 2026), a **daily training checklist** that auto-ticks from real app signals (WaniKani reviews cleared, deck reviews done, speaking practiced) with manual ticks for the rest, a 14-day heatmap, an **N-level vocabulary-coverage lens** (how much of the official word list is in your deck / known on WaniKani), and the four exam papers mapped to the surfaces that train them. Level selectable N5–N1; the plan syncs to your account. |
