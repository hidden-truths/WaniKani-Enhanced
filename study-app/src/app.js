...
// ACCESSIBILITY (setupRoving + annotateJlptChips/annotateCatChips/annotateSourceChips) →
// features/a11y.js. annotate* are imported (rebuildData calls them); initA11y() runs the
// boot pass (annotate all three, then roving-tabindex every chip group).
initA11y();
