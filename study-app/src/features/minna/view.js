...
export async function renderMinna() {
  ...
  S.lessons = lessons;
  head.innerHTML = `<div class="marker"><div class="idx">05<span class="slash"> / 08</span></div><div class="ttl jp-min">教科書</div><div class="en">Textbook</div><div class="rule"></div></div>`;
