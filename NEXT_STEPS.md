...
- **Post-B enhancement follow-ups** (independent, not yet done): E1 per-blob 409 merge; E2 idempotency keys for `POST /v1/sessions` + the recording upload; E3 route the upload through the transport — see [REFACTOR_FOLLOWUPS.md](REFACTOR_FOLLOWUPS.md) "Enhancement follow-ups".
