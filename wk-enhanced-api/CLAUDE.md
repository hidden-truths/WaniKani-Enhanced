...
| GET | `/v1/progress/{app}` | Cookie | Fetch the user's progress blob (`app` ∈ {`verbs`, `custom-verbs`, `settings`, `minna`, `selftalk`, `songs`}). 401 if logged out. |
