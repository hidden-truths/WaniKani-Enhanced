...
│   ├── singleFlight.ts       # generic keyed in-flight coalescing (one upstream call per key under a concurrent herd); backs mediaCache, generalizes the warm pipeline's bespoke per-word ddgInFlight
│   └── sleep.ts
